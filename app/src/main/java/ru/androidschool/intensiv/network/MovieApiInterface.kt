...
interface MovieApiInterface{
    ...
    @GET("tv/popular")
    fun getPopularTvShows(@Query("api_key") apiKey: String = BuildConfig.THE_MOVIE_DATABASE_API): Call<TvShowResponse>

    @GET("movie/{movie_id}/credits")
    fun getActors(@Path("movie_id") movieId: Int, @Query("api_key") apiKey: String = BuildConfig.THE_MOVIE_DATABASE_API): Call<ActorsResponse>

    @GET("movie/{movie_id}")
    fun getMoviesDetails(@Path("movie_id") movieId: Int, @Query("api_key") apiKey: String = BuildConfig.THE_MOVIE_DATABASE_API): Call<MovieDetails>
}
